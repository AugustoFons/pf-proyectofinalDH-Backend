...
| #30 Reservas: Seleccionar fecha   | Crear una reserva con rango de fechas válido                             | La reserva se crea exitosamente y el modal de confirmación                       | OK                 |
| #31 Reservas: Visualizar detalles | Hacer clic en "Reservar ahora" con rango de fechas válido                | Se abre el modal de confirmación de reserva con toda la información del producto | OK                 |
| #31 Reservas: Visualizar detalles | Verificar el bloque de detalle del producto en el modal                  | Se visualizan imagen, nombre, precio y descripción del producto                  | OK                 |
| #31 Reservas: Visualizar detalles | Verificar el bloque con datos del usuario                                | Se muestra nombre, apellido y correo del usuario autenticado                     | OK                 |
| #31 Reservas: Visualizar detalles | Hacer clic en "Confirmar reserva"                                        | Se ejecuta la creación de la reserva.                                            | OK                 |
| #32 Realizar reserva              | Confirmar una reserva con rango de fechas válido                         | La reserva se crea y el modal pasa a la vista de comprobante                     | OK                 |
| #32 Realizar reserva              | Hacer clic en "Ir a mi actividad" desde el comprobante                   | Se cierra el modal y se navega a `/actividad`, donde figura la reserva creada    | OK                 |
| #33 Acceder a historial           | Acceder a "Mi Actividad" desde el menú del avatar                        | Se abre `/actividad` con la pestaña "Reservas" y el historial del usuario        | OK                 |
| #34 WhatsApp: Iniciar chat        | Verificar el botón de WhatsApp en distintas pantallas                    | El botón flotante es visible en la esquina inferior derecha en todas las páginas | OK                 |
| #34 WhatsApp: Iniciar chat        | Hacer clic en el botón de WhatsApp                 | Se abre WhatsApp con el número del proveedor y el mensaje precargado              | OK                 |
| #35 Notificación por correo       | Confirmar una compra/reserva y observar el modal de éxito                | El modal muestra un aviso de que se enviará un correo con el resumen a su email y este llega correctamente   | OK                 |
